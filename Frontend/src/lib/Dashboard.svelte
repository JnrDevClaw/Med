                            ...
                            >
                                <div class="flex items-center space-x-3">
                                    <div class="w-10 h-10 bg-primary-50 rounded-lg flex items-center justify-center">
                                        <Icon name="plus" class="w-5 h-5 text-primary-600" />
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium">New Consultation</p>
                                        <p class="text-xs text-gray-500">Quickly start a new consult</p>
                                    </div>
                                </div>
                            </button>
                        {/if}
